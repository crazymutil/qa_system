...
def index():
    """ 首页 """
    return render_template('../qa/templates/index.html')


@app.route('/follow')
def follow():
    """ 关注 """
    return render_template('../qa/templates/follow.html')


@app.route('/login')
def login():
    """ 登录页面 """
    return render_template('../accounts/templates/login.html')


@app.route('/register')
def register():
    """ 注册 """
    return render_template('../accounts/templates/register.html')


@app.route('/write')
def write():
    """ 写文章，提问 """
    return render_template('../qa/templates/write.html')


@app.route('/mine')
def mine():
    """ 个人中心 """
    return render_template('../accounts/templates/mine.html')


@app.route('/detail')
def detail():
    """ 问题详情 """
    return render_template('../qa/templates/detail.html')
